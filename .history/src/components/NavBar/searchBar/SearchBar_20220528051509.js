...
class SearchBar extends Component {
  ...
  submitCommunity = (event) => {
    const commentHome = constantClass.currentLocation + "commentPost"
    const submitHome = constantClass.currentLocation + "submitPost"
    const communityHome = constantClass.currentLocation + "communityPost"
     if (event.key === "Enter") { 
      if (window.location.href === communityHome) {
