...
import import InsertLinkIcon from '@material-ui/icons/InsertLinkOutlined'; from '@material-ui/icons/InsertLinkOutlined';
...
class SumbitPostTest extends Component {
  ...
  componentDidMount() {
    ...
    line.style.width = `${buttonActive.offsetWidth-57}px`;
