    ...
    return ( 
      <div className="form-box">
        <div   className="signin-form form">
          <h3>Login</h3>
          <input type="text" placeholder="Email" id='usename1'
            value={JSON.parse(localStorage.getItem("userInfo")).userEmail}
            onChange={(event) => { this.state.emailId = event.currentTarget.value }} />
          <input type="password" placeholder="Password" id='pwd1'
            value={JSON.parse(localStorage.getItem("userInfo")).password}
