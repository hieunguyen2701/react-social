            ...
            <div className="posts">
                ...
                <div className="post-comment" >
                  ...
                  <div className="comment-input">
                    <img className='post' src={`https://avatars.dicebear.com/api/open-peeps/${this.props.username}.svg`} />   
                    <input placeholder="what are you thoughts?" text="text"  onKeyPress={this.submitComments} id="post-commentID"/>
                  </div>
